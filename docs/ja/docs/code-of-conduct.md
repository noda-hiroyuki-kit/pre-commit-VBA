...
# コントリビューター行動規範 3.0 { #contributor-covenant-3-0-code-of-conduct }
...
問題が発生した場合は, 速やかに報告することが重要です. 本行動規範に反する可能性のある行為については, **[noda-hiroyuki-kit](https://github.com/noda-hiroyuki-kit)**に報告してください.
...
## 問題への対処と修復 { #addressing-and-repairing-harm }
